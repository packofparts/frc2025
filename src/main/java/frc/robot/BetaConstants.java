...
public final class BetaConstants {
    ...
    public static final class Intake {
        public static final double GEAR_RATIO = 157.5; // tbd
        ...
        public static final FFConfig FF = new FFConfig(0.5, 0.0, 0.0); // tbd

        public static final AbsoluteEncoderConfig ENCODER = new AbsoluteEncoderConfig(9, Rotation2d.fromDegrees(-48.0), true); // tbd
        public static final double MAX_ERROR = 1.0;
        public static final double SPEED = 1.0; // tbd
